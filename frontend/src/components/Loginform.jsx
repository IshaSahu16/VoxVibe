        ...
        <div className=" block p-6 max-w-sm  m-auto bg-[#fff3f3] bg-opacity-60 rounded-lg shadow border border-white border-opacity-80 backdrop-blur-xl">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group mb-6">
              ...
              border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"      id="exampleInputPassword16"
                placeholder="Password" />
            </div>

            <button type="submit" className=" w-full px-6 py-2.5  bg-[#38389a] text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-[#4141ae]   hover:shadow-lg focus:bg-[#4141ae] focus:shadow-lg focus:outline-none focus:ring-0 active:bg-[#38389a] active:shadow-lg transition duration-150   ease-in-out">Login</button>

            <p className="text-gray-800 mt-6 text-center">Are you a new member? <button
              className="hover:text-[#38389a] focus:text-[#38389a] transition duration-200 ease-in-out text-[#38389a]"><Link to="/Signup">Signup</Link></button>
            </p>
          </form>
        </div>
